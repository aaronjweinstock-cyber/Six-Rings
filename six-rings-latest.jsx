  ...
  return (
    <div className="wrap">
      <style>{`
        ...
        .todaysBest { background: rgba(217,164,65,0.08); border: 1px solid rgba(217,164,65,0.35); border-radius: 10px; padding: 12px 18px; text-align: center; }
        .todaysBest.hard { background: rgba(193,68,58,0.08); border-color: rgba(193,68,58,0.35); }
        .todaysBest.impossible { background: rgba(237,230,214,0.06); border-color: rgba(237,230,214,0.3); }
        .todaysBest .tbLabel { font-family: 'IBM Plex Mono', monospace; font-size: 11px; letter-spacing: 1.5px; color: #D9A441; text-transform: uppercase; margin-bottom: 6px; }
        .todaysBest.hard .tbLabel { color: #E0958E; }
        .todaysBest.impossible .tbLabel { color: #EDE6D6; }
