...
const DRAFT_CLASSES = [
  ...
  { year: 2002, players: [
    ...
    { name: "Fred Jones", pick: 14, pos: ["G"], scoring: 66, playmaking: 45, rebounding: 48, defense: 74, ovr: 68 },
    { name: "Bostjan Nachbar", pick: 15, pos: ["F"], scoring: 64, playmaking: 40, rebounding: 52, defense: 45, ovr: 66 },
    { name: "Jiri Welsch", pick: 16, pos: ["G", "F"], scoring: 55, playmaking: 48, rebounding: 42, defense: 50, ovr: 58 },
    { name: "Juan Dixon", pick: 17, pos: ["G"], scoring: 68, playmaking: 50, rebounding: 30, defense: 48, ovr: 65 },
    { name: "Curtis Borchardt", pick: 18, pos: ["C"], scoring: 40, playmaking: 25, rebounding: 55, defense: 50, ovr: 46 },
    { name: "Ryan Humphrey", pick: 19, pos: ["F"], scoring: 45, playmaking: 25, rebounding: 58, defense: 45, ovr: 48 },
    { name: "Kareem Rush", pick: 20, pos: ["G"], scoring: 66, playmaking: 45, rebounding: 40, defense: 52, ovr: 64 },
    { name: "Qyntel Woods", pick: 21, pos: ["F"], scoring: 50, playmaking: 35, rebounding: 48, defense: 42, ovr: 48 },
    { name: "Casey Jacobsen", pick: 22, pos: ["G", "F"], scoring: 58, playmaking: 38, rebounding: 35, defense: 40, ovr: 56 },
    { name: "Tayshaun Prince", pick: 23, pos: ["F"], scoring: 72, playmaking: 52, rebounding: 55, defense: 82, ovr: 76 },
    { name: "Nenad Krstic", pick: 24, pos: ["C"], scoring: 72, playmaking: 40, rebounding: 68, defense: 58, ovr: 76 },
    { name: "Frank Williams", pick: 25, pos: ["G"], scoring: 42, playmaking: 60, rebounding: 30, defense: 45, ovr: 50 },
    { name: "John Salmons", pick: 26, pos: ["G", "F"], scoring: 70, playmaking: 52, rebounding: 45, defense: 58, ovr: 68 },
    { name: "Chris Jefferies", pick: 27, pos: ["F"], scoring: 38, playmaking: 30, rebounding: 45, defense: 38, ovr: 42 },
    { name: "Dan Dickau", pick: 28, pos: ["G"], scoring: 52, playmaking: 62, rebounding: 28, defense: 42, ovr: 58 },
  ...
  { year: 2003, players: [
    ...
    { name: "Mike Sweetney", pick: 9, pos: ["F", "C"], scoring: 58, playmaking: 30, rebounding: 72, defense: 48, ovr: 55 },
    { name: "Jarvis Hayes", pick: 10, pos: ["G", "F"], scoring: 72, playmaking: 40, rebounding: 45, defense: 47, ovr: 68 },
    { name: "Mickael Pietrus", pick: 11, pos: ["G", "F"], scoring: 68, playmaking: 40, rebounding: 55, defense: 80, ovr: 77 },
    { name: "Nick Collison", pick: 12, pos: ["F", "C"], scoring: 58, playmaking: 42, rebounding: 66, defense: 62, ovr: 62 },
    { name: "Marcus Banks", pick: 13, pos: ["G"], scoring: 50, playmaking: 60, rebounding: 30, defense: 76, ovr: 65 },
    { name: "Luke Ridnour", pick: 14, pos: ["G"], scoring: 66, playmaking: 68, rebounding: 40, defense: 52, ovr: 64 },
    { name: "Reece Gaines", pick: 15, pos: ["G"], scoring: 45, playmaking: 42, rebounding: 30, defense: 48, ovr: 47 },
    { name: "Troy Bell", pick: 16, pos: ["G"], scoring: 48, playmaking: 40, rebounding: 25, defense: 38, ovr: 44 },
    { name: "Zarko Cabarkapa", pick: 17, pos: ["F"], scoring: 55, playmaking: 35, rebounding: 55, defense: 42, ovr: 52 },
    { name: "David West", pick: 18, pos: ["F"], scoring: 80, playmaking: 55, rebounding: 76, defense: 68, ovr: 82 },
    { name: "Sasha Pavlovic", pick: 19, pos: ["G", "F"], scoring: 68, playmaking: 48, rebounding: 45, defense: 55, ovr: 70 },
    { name: "Dahntay Jones", pick: 20, pos: ["G"], scoring: 62, playmaking: 42, rebounding: 43, defense: 90, ovr: 73 },
    { name: "Boris Diaw", pick: 21, pos: ["F","C"], scoring: 70, playmaking: 72, rebounding: 62, defense: 65, ovr: 74 },
    { name: "Zoran Planinic", pick: 22, pos: ["G"], scoring: 50, playmaking: 62, rebounding: 30, defense: 45, ovr: 54 },
    { name: "Travis Outlaw", pick: 23, pos: ["F"], scoring: 76, playmaking: 35, rebounding: 52, defense: 55, ovr: 74 },
    { name: "Brian Cook", pick: 24, pos: ["F", "C"], scoring: 68, playmaking: 32, rebounding: 58, defense: 40, ovr: 66 },
    { name: "Carlos Delfino", pick: 25, pos: ["G", "F"], scoring: 70, playmaking: 52, rebounding: 60, defense: 74, ovr: 75 },
    { name: "Ndudi Ebi", pick: 26, pos: ["F"], scoring: 48, playmaking: 30, rebounding: 42, defense: 40, ovr: 45 },
  ...
  { year: 2004, players: [
    ...
    { name: "Robert Swift", pick: 12, pos: ["C"], scoring: 30, playmaking: 20, rebounding: 55, defense: 50, ovr: 46 },
    { name: "Sebastian Telfair", pick: 13, pos: ["G"], scoring: 62, playmaking: 62, rebounding: 36, defense: 50, ovr: 60 },
    { name: "Kris Humphries", pick: 14, pos: ["F"], scoring: 62, playmaking: 25, rebounding: 82, defense: 48, ovr: 73 },
    ...
    { name: "J.R. Smith", pick: 18, pos: ["G", "F"], scoring: 84, playmaking: 48, rebounding: 45, defense: 55, ovr: 80 },
    { name: "Dorell Wright", pick: 19, pos: ["F"], scoring: 72, playmaking: 40, rebounding: 55, defense: 58, ovr: 75 },
    { name: "Jameer Nelson", pick: 20, pos: ["G"], scoring: 74, playmaking: 72, rebounding: 42, defense: 55, ovr: 72 },
    { name: "Pavel Podkolzin", pick: 21, pos: ["C"], scoring: 20, playmaking: 15, rebounding: 45, defense: 35, ovr: 41 },
    { name: "Viktor Khryapa", pick: 22, pos: ["F"], scoring: 42, playmaking: 45, rebounding: 58, defense: 60, ovr: 60 },
    { name: "Sergei Monia", pick: 23, pos: ["F"], scoring: 40, playmaking: 30, rebounding: 45, defense: 42, ovr: 48 },
    { name: "Delonte West", pick: 24, pos: ["G"], scoring: 68, playmaking: 58, rebounding: 45, defense: 68, ovr: 68 },
    { name: "Tony Allen", pick: 25, pos: ["G"], scoring: 55, playmaking: 40, rebounding: 55, defense: 90, ovr: 78 },
    { name: "Kevin Martin", pick: 26, pos: ["G"], scoring: 82, playmaking: 48, rebounding: 42, defense: 48, ovr: 78 },
    { name: "Sasha Vujacic", pick: 27, pos: ["G"], scoring: 68, playmaking: 42, rebounding: 30, defense: 48, ovr: 68 },
    { name: "Beno Udrih", pick: 28, pos: ["G"], scoring: 68, playmaking: 72, rebounding: 32, defense: 45, ovr: 74 },
    { name: "David Harrison", pick: 29, pos: ["C"], scoring: 35, playmaking: 20, rebounding: 58, defense: 52, ovr: 53 },
  ...
  { year: 2005, players: [
    ...
    { name: "Martell Webster", pick: 6, pos: ["G", "F"], scoring: 74, playmaking: 40, rebounding: 45, defense: 58, ovr: 71 },
    ...
    { name: "Fran Vazquez", pick: 11, pos: ["F", "C"], scoring: 40, playmaking: 25, rebounding: 78, defense: 82, ovr: 70 },
    { name: "Yaroslav Korolev", pick: 12, pos: ["F"], scoring: 40, playmaking: 25, rebounding: 40, defense: 38, ovr: 44 },
    ...
    { name: "Joey Graham", pick: 16, pos: ["F"], scoring: 58, playmaking: 32, rebounding: 48, defense: 52, ovr: 59 },
    { name: "Danny Granger", pick: 17, pos: ["F"], scoring: 80, playmaking: 50, rebounding: 58, defense: 58, ovr: 76 },
    { name: "Gerald Green", pick: 18, pos: ["G", "F"], scoring: 79, playmaking: 38, rebounding: 40, defense: 46, ovr: 76 },
    { name: "Hakim Warrick", pick: 19, pos: ["F"], scoring: 73, playmaking: 35, rebounding: 62, defense: 50, ovr: 74 },
    { name: "Julius Hodge", pick: 20, pos: ["G"], scoring: 38, playmaking: 42, rebounding: 30, defense: 35, ovr: 43 },
    ...
    { name: "Francisco Garcia", pick: 23, pos: ["G", "F"], scoring: 62, playmaking: 42, rebounding: 45, defense: 65, ovr: 69 },
    { name: "Luther Head", pick: 24, pos: ["G"], scoring: 68, playmaking: 55, rebounding: 30, defense: 48, ovr: 73 },
    { name: "Johan Petro", pick: 25, pos: ["C"], scoring: 42, playmaking: 25, rebounding: 62, defense: 55, ovr: 58 },
    { name: "Jason Maxiell", pick: 26, pos: ["F", "C"], scoring: 55, playmaking: 25, rebounding: 68, defense: 65, ovr: 66 },
    { name: "Linas Kleiza", pick: 27, pos: ["F"], scoring: 71, playmaking: 38, rebounding: 55, defense: 42, ovr: 74 },
    { name: "Ian Mahinmi", pick: 28, pos: ["C"], scoring: 40, playmaking: 25, rebounding: 68, defense: 78, ovr: 74 },
    { name: "Wayne Simien", pick: 29, pos: ["F"], scoring: 40, playmaking: 20, rebounding: 52, defense: 40, ovr: 45 },
  ...
  { year: 2006, players: [
    ...
    { name: "Hilton Armstrong", pick: 12, pos: ["C"], scoring: 32, playmaking: 20, rebounding: 58, defense: 58, ovr: 53 },
    ...
    { name: "Cedric Simmons", pick: 15, pos: ["F"], scoring: 28, playmaking: 15, rebounding: 50, defense: 48, ovr: 47 },
    { name: "Rodney Carney", pick: 16, pos: ["F"], scoring: 62, playmaking: 30, rebounding: 48, defense: 55, ovr: 64 },
    { name: "Shawne Williams", pick: 17, pos: ["F"], scoring: 60, playmaking: 25, rebounding: 52, defense: 42, ovr: 61 },
    { name: "Oleksiy Pecherov", pick: 18, pos: ["F", "C"], scoring: 45, playmaking: 25, rebounding: 48, defense: 40, ovr: 50 },
    { name: "Quincy Douby", pick: 19, pos: ["G"], scoring: 55, playmaking: 40, rebounding: 25, defense: 35, ovr: 52 },
    { name: "Renaldo Balkman", pick: 20, pos: ["F"], scoring: 35, playmaking: 25, rebounding: 62, defense: 65, ovr: 55 },
    ...
    { name: "Josh Boone", pick: 23, pos: ["C"], scoring: 45, playmaking: 25, rebounding: 68, defense: 62, ovr: 60 },
    { name: "Kyle Lowry", pick: 24, pos: ["G"], scoring: 83, playmaking: 85, rebounding: 56, defense: 83, ovr: 87 },
    { name: "Shannon Brown", pick: 25, pos: ["G"], scoring: 74, playmaking: 45, rebounding: 40, defense: 55, ovr: 72 },
    { name: "Jordan Farmar", pick: 26, pos: ["G"], scoring: 62, playmaking: 74, rebounding: 25, defense: 50, ovr: 70 },
    { name: "Sergio Rodriguez", pick: 27, pos: ["G"], scoring: 40, playmaking: 82, rebounding: 25, defense: 35, ovr: 64 },
    { name: "Maurice Ager", pick: 28, pos: ["G"], scoring: 45, playmaking: 30, rebounding: 30, defense: 35, ovr: 48 },
    { name: "Mardy Collins", pick: 29, pos: ["G"], scoring: 42, playmaking: 45, rebounding: 35, defense: 55, ovr: 54 },
    { name: "Joel Freeland", pick: 30, pos: ["F", "C"], scoring: 40, playmaking: 25, rebounding: 62, defense: 58, ovr: 58 },
  ...
  { year: 2007, players: [
    ...
    { name: "Kevin Durant", pick: 2, pos: ["F"], scoring: 98, playmaking: 62, rebounding: 64, defense: 62, ovr: 97 },
    ...
    { name: "Al Thornton", pick: 14, pos: ["F"], scoring: 74, playmaking: 32, rebounding: 52, defense: 42, ovr: 68 },
    ...
    { name: "Sean Williams", pick: 17, pos: ["F", "C"], scoring: 38, playmaking: 25, rebounding: 68, defense: 70, ovr: 60 },
    { name: "Marco Belinelli", pick: 18, pos: ["G"], scoring: 78, playmaking: 58, rebounding: 28, defense: 40, ovr: 75 },
    { name: "Javaris Crittenton", pick: 19, pos: ["G"], scoring: 48, playmaking: 52, rebounding: 25, defense: 45, ovr: 53 },
    { name: "Jason Smith", pick: 20, pos: ["F", "C"], scoring: 62, playmaking: 30, rebounding: 60, defense: 48, ovr: 65 },
    { name: "Daequan Cook", pick: 21, pos: ["G"], scoring: 72, playmaking: 35, rebounding: 30, defense: 45, ovr: 73 },
    ...
    { name: "Rudy Fernandez", pick: 24, pos: ["G"], scoring: 74, playmaking: 55, rebounding: 35, defense: 50, ovr: 75 },
    { name: "Morris Almond", pick: 25, pos: ["G"], scoring: 50, playmaking: 30, rebounding: 28, defense: 32, ovr: 48 },
    ...
    { name: "Tiago Splitter", pick: 28, pos: ["C"], scoring: 62, playmaking: 40, rebounding: 78, defense: 80, ovr: 77 },
    { name: "Alando Tucker", pick: 29, pos: ["F"], scoring: 58, playmaking: 25, rebounding: 40, defense: 35, ovr: 53 },
    { name: "Petteri Koponen", pick: 30, pos: ["G"], scoring: 42, playmaking: 48, rebounding: 20, defense: 30, ovr: 44 },
  ...
  { year: 2008, players: [
    ...
    { name: "Joe Alexander", pick: 8, pos: ["F"], scoring: 46, playmaking: 28, rebounding: 44, defense: 40, ovr: 50 },
    { name: "D.J. Augustin", pick: 9, pos: ["G"], scoring: 78, playmaking: 76, rebounding: 30, defense: 55, ovr: 80 },
    ...
    { name: "Brandon Rush", pick: 13, pos: ["G", "F"], scoring: 68, playmaking: 45, rebounding: 55, defense: 72, ovr: 70 },
    ...
    { name: "J.J. Hickson", pick: 19, pos: ["F", "C"], scoring: 68, playmaking: 30, rebounding: 82, defense: 60, ovr: 75 },
    { name: "Alexis Ajinca", pick: 20, pos: ["C"], scoring: 55, playmaking: 25, rebounding: 70, defense: 62, ovr: 64 },
    ...
    { name: "Kosta Koufos", pick: 23, pos: ["C"], scoring: 62, playmaking: 30, rebounding: 82, defense: 72, ovr: 75 },
    ...
    { name: "Darrell Arthur", pick: 27, pos: ["F"], scoring: 68, playmaking: 35, rebounding: 62, defense: 74, ovr: 73 },
    { name: "Donte Greene", pick: 28, pos: ["F"], scoring: 58, playmaking: 30, rebounding: 45, defense: 38, ovr: 55 },
    { name: "D.J. White", pick: 29, pos: ["F"], scoring: 52, playmaking: 25, rebounding: 58, defense: 48, ovr: 58 },
    { name: "J.R. Giddens", pick: 30, pos: ["G"], scoring: 45, playmaking: 35, rebounding: 30, defense: 42, ovr: 47 },
    { name: "DeAndre Jordan", pick: 35, pos: ["C"], scoring: 69, playmaking: 38, rebounding: 99, defense: 93, ovr: 87 },
  ]},
  { year: 2009, players: [
    { name: "Blake Griffin", pick: 1, pos: ["F"], scoring: 89, playmaking: 65, rebounding: 85, defense: 65, ovr: 90 },
    ...
    { name: "Jonny Flynn", pick: 6, pos: ["G"], scoring: 66, playmaking: 60, rebounding: 30, defense: 38, ovr: 56 },
    ...
    { name: "DeMar DeRozan", pick: 9, pos: ["G","F"], scoring: 90, playmaking: 59, rebounding: 52, defense: 62, ovr: 89 },
    { name: "Brandon Jennings", pick: 10, pos: ["G"], scoring: 74, playmaking: 68, rebounding: 40, defense: 52, ovr: 72 },
    { name: "Terrence Williams", pick: 11, pos: ["G", "F"], scoring: 54, playmaking: 56, rebounding: 46, defense: 48, ovr: 55 },
    { name: "Gerald Henderson", pick: 12, pos: ["G"], scoring: 68, playmaking: 48, rebounding: 48, defense: 58, ovr: 66 },
    { name: "Tyler Hansbrough", pick: 13, pos: ["F"], scoring: 60, playmaking: 28, rebounding: 76, defense: 66, ovr: 68 },
    { name: "Earl Clark", pick: 14, pos: ["F"], scoring: 48, playmaking: 38, rebounding: 56, defense: 48, ovr: 54 },
    { name: "Austin Daye", pick: 15, pos: ["F"], scoring: 58, playmaking: 34, rebounding: 46, defense: 40, ovr: 56 },
    { name: "James Johnson", pick: 16, pos: ["F"], scoring: 64, playmaking: 56, rebounding: 60, defense: 76, ovr: 74 },
    ...
    { name: "Eric Maynor", pick: 20, pos: ["G"], scoring: 52, playmaking: 64, rebounding: 28, defense: 54, ovr: 63 },
    { name: "Darren Collison", pick: 21, pos: ["G"], scoring: 70, playmaking: 66, rebounding: 40, defense: 55, ovr: 68 },
    { name: "Victor Claver", pick: 22, pos: ["F"], scoring: 44, playmaking: 34, rebounding: 50, defense: 44, ovr: 52 },
    { name: "Omri Casspi", pick: 23, pos: ["F"], scoring: 68, playmaking: 42, rebounding: 55, defense: 55, ovr: 68 },
    { name: "B.J. Mullens", pick: 24, pos: ["C"], scoring: 56, playmaking: 24, rebounding: 54, defense: 40, ovr: 54 },
    { name: "Rodrigue Beaubois", pick: 25, pos: ["G"], scoring: 72, playmaking: 60, rebounding: 32, defense: 46, ovr: 70 },
    { name: "Taj Gibson", pick: 26, pos: ["F","C"], scoring: 64, playmaking: 38, rebounding: 74, defense: 78, ovr: 74 },
    { name: "DeMarre Carroll", pick: 27, pos: ["F"], scoring: 66, playmaking: 42, rebounding: 60, defense: 80, ovr: 76 },
    { name: "Wayne Ellington", pick: 28, pos: ["G"], scoring: 74, playmaking: 32, rebounding: 26, defense: 46, ovr: 74 },
    { name: "Toney Douglas", pick: 29, pos: ["G"], scoring: 58, playmaking: 48, rebounding: 30, defense: 58, ovr: 60 },
    { name: "Christian Eyenga", pick: 30, pos: ["F"], scoring: 40, playmaking: 28, rebounding: 44, defense: 40, ovr: 46 },
  ...
  { year: 2010, players: [
    ...
    { name: "Paul George", pick: 10, pos: ["F"], scoring: 93, playmaking: 62, rebounding: 69, defense: 87, ovr: 93 },
    { name: "Cole Aldrich", pick: 11, pos: ["C"], scoring: 52, playmaking: 32, rebounding: 66, defense: 64, ovr: 58 },
    { name: "Xavier Henry", pick: 12, pos: ["G"], scoring: 66, playmaking: 40, rebounding: 38, defense: 46, ovr: 58 },
    ...
    { name: "Luke Babbitt", pick: 16, pos: ["F"], scoring: 66, playmaking: 32, rebounding: 48, defense: 45, ovr: 68 },
    { name: "Kevin Seraphin", pick: 17, pos: ["F", "C"], scoring: 62, playmaking: 28, rebounding: 62, defense: 55, ovr: 68 },
    ...
    { name: "James Anderson", pick: 20, pos: ["G"], scoring: 50, playmaking: 38, rebounding: 32, defense: 42, ovr: 52 },
    { name: "Craig Brackins", pick: 21, pos: ["F"], scoring: 40, playmaking: 24, rebounding: 44, defense: 34, ovr: 45 },
    { name: "Elliot Williams", pick: 22, pos: ["G"], scoring: 46, playmaking: 40, rebounding: 30, defense: 42, ovr: 50 },
    { name: "Trevor Booker", pick: 23, pos: ["F"], scoring: 62, playmaking: 35, rebounding: 74, defense: 68, ovr: 71 },
    { name: "Damion James", pick: 24, pos: ["F"], scoring: 44, playmaking: 28, rebounding: 52, defense: 40, ovr: 48 },
    { name: "Dominique Jones", pick: 25, pos: ["G"], scoring: 56, playmaking: 46, rebounding: 34, defense: 42, ovr: 53 },
    { name: "Quincy Pondexter", pick: 26, pos: ["F"], scoring: 64, playmaking: 38, rebounding: 52, defense: 66, ovr: 71 },
    { name: "Jordan Crawford", pick: 27, pos: ["G"], scoring: 78, playmaking: 55, rebounding: 30, defense: 38, ovr: 71 },
    { name: "Greivis Vasquez", pick: 28, pos: ["G"], scoring: 66, playmaking: 66, rebounding: 42, defense: 50, ovr: 64 },
    { name: "Daniel Orton", pick: 29, pos: ["C"], scoring: 38, playmaking: 20, rebounding: 55, defense: 50, ovr: 45 },
    { name: "Lazar Hayward", pick: 30, pos: ["F"], scoring: 46, playmaking: 28, rebounding: 44, defense: 38, ovr: 47 },
  ...
  { year: 2011, players: [
    { name: "Kyrie Irving", pick: 1, pos: ["G"], scoring: 95, playmaking: 91, rebounding: 41, defense: 61, ovr: 93 },
    { name: "Derrick Williams", pick: 2, pos: ["F"], scoring: 75, playmaking: 40, rebounding: 65, defense: 52, ovr: 76 },
    ...
    { name: "Jan Vesely", pick: 6, pos: ["F"], scoring: 45, playmaking: 30, rebounding: 60, defense: 52, ovr: 55 },
    ...
    { name: "Jimmer Fredette", pick: 10, pos: ["G"], scoring: 78, playmaking: 45, rebounding: 30, defense: 35, ovr: 70 },
    { name: "Klay Thompson", pick: 11, pos: ["G"], scoring: 91, playmaking: 51, rebounding: 48, defense: 78, ovr: 91 },
    ...
    { name: "Kawhi Leonard", pick: 15, pos: ["F"], scoring: 89, playmaking: 55, rebounding: 73, defense: 98, ovr: 97 },
    ...
    { name: "Chris Singleton", pick: 18, pos: ["F"], scoring: 40, playmaking: 30, rebounding: 55, defense: 60, ovr: 56 },
    { name: "Tobias Harris", pick: 19, pos: ["F"], scoring: 78, playmaking: 50, rebounding: 62, defense: 58, ovr: 79 },
    { name: "Donatas Motiejunas", pick: 20, pos: ["F", "C"], scoring: 68, playmaking: 45, rebounding: 68, defense: 50, ovr: 75 },
    { name: "Nolan Smith", pick: 21, pos: ["G"], scoring: 42, playmaking: 55, rebounding: 30, defense: 42, ovr: 53 },
    { name: "Kenneth Faried", pick: 22, pos: ["F"], scoring: 62, playmaking: 25, rebounding: 88, defense: 68, ovr: 79 },
    ...
    { name: "Marshon Brooks", pick: 25, pos: ["G"], scoring: 68, playmaking: 40, rebounding: 35, defense: 40, ovr: 62 },
    { name: "Jordan Hamilton", pick: 26, pos: ["F"], scoring: 62, playmaking: 35, rebounding: 45, defense: 42, ovr: 60 },
    { name: "JaJuan Johnson", pick: 27, pos: ["F", "C"], scoring: 38, playmaking: 25, rebounding: 50, defense: 45, ovr: 49 },
    { name: "Norris Cole", pick: 28, pos: ["G"], scoring: 62, playmaking: 70, rebounding: 32, defense: 66, ovr: 75 },
    { name: "Cory Joseph", pick: 29, pos: ["G"], scoring: 60, playmaking: 70, rebounding: 32, defense: 70, ovr: 75 },
    { name: "Jimmy Butler", pick: 30, pos: ["F","G"], scoring: 88, playmaking: 70, rebounding: 64, defense: 92, ovr: 95 },
  ...
  { year: 2012, players: [
    ...
    { name: "Terrence Ross", pick: 8, pos: ["G", "F"], scoring: 78, playmaking: 42, rebounding: 40, defense: 55, ovr: 79 },
    ...
    { name: "Jeremy Lamb", pick: 12, pos: ["G"], scoring: 76, playmaking: 48, rebounding: 42, defense: 52, ovr: 79 },
    { name: "Kendall Marshall", pick: 13, pos: ["G"], scoring: 40, playmaking: 75, rebounding: 35, defense: 40, ovr: 65 },
    { name: "John Henson", pick: 14, pos: ["F", "C"], scoring: 58, playmaking: 38, rebounding: 66, defense: 72, ovr: 64 },
    { name: "Maurice Harkless", pick: 15, pos: ["F"], scoring: 58, playmaking: 40, rebounding: 52, defense: 68, ovr: 73 },
    { name: "Royce White", pick: 16, pos: ["F"], scoring: 45, playmaking: 45, rebounding: 50, defense: 45, ovr: 55 },
    { name: "Tyler Zeller", pick: 17, pos: ["C"], scoring: 62, playmaking: 40, rebounding: 64, defense: 55, ovr: 62 },
    { name: "Terrence Jones", pick: 18, pos: ["F"], scoring: 62, playmaking: 42, rebounding: 62, defense: 58, ovr: 74 },
    { name: "Andrew Nicholson", pick: 19, pos: ["F"], scoring: 60, playmaking: 35, rebounding: 55, defense: 52, ovr: 69 },
    ...
    { name: "Fab Melo", pick: 22, pos: ["C"], scoring: 35, playmaking: 25, rebounding: 55, defense: 50, ovr: 50 },
    { name: "John Jenkins", pick: 23, pos: ["G"], scoring: 62, playmaking: 30, rebounding: 30, defense: 42, ovr: 68 },
    { name: "Jared Cunningham", pick: 24, pos: ["G"], scoring: 42, playmaking: 35, rebounding: 32, defense: 45, ovr: 55 },
    { name: "Tony Wroten", pick: 25, pos: ["G"], scoring: 68, playmaking: 58, rebounding: 40, defense: 45, ovr: 75 },
    { name: "Miles Plumlee", pick: 26, pos: ["C"], scoring: 45, playmaking: 30, rebounding: 65, defense: 58, ovr: 70 },
    { name: "Arnett Moultrie", pick: 27, pos: ["F"], scoring: 38, playmaking: 28, rebounding: 50, defense: 42, ovr: 52 },
    { name: "Perry Jones III", pick: 28, pos: ["F"], scoring: 58, playmaking: 35, rebounding: 42, defense: 40, ovr: 62 },
    { name: "Marquis Teague", pick: 29, pos: ["G"], scoring: 35, playmaking: 45, rebounding: 30, defense: 38, ovr: 53 },
    ...
    { name: "Draymond Green", pick: 35, pos: ["F"], scoring: 70, playmaking: 80, rebounding: 80, defense: 99, ovr: 90 },
    { name: "Khris Middleton", pick: 39, pos: ["F"], scoring: 80, playmaking: 58, rebounding: 55, defense: 62, ovr: 80 },
  ]},
  { year: 2013, players: [
    { name: "Anthony Bennett", pick: 1, pos: ["F"], scoring: 45, playmaking: 22, rebounding: 52, defense: 38, ovr: 47 },
    ...
    { name: "Ben McLemore", pick: 7, pos: ["G"], scoring: 68, playmaking: 32, rebounding: 28, defense: 42, ovr: 63 },
    ...
    { name: "Lucas Nogueira", pick: 16, pos: ["C"], scoring: 38, playmaking: 20, rebounding: 62, defense: 66, ovr: 57 },
    { name: "Dennis Schroder", pick: 17, pos: ["G"], scoring: 76, playmaking: 72, rebounding: 32, defense: 58, ovr: 76 },
    { name: "Shane Larkin", pick: 18, pos: ["G"], scoring: 54, playmaking: 66, rebounding: 24, defense: 50, ovr: 60 },
    { name: "Sergey Karasev", pick: 19, pos: ["G", "F"], scoring: 44, playmaking: 34, rebounding: 28, defense: 34, ovr: 49 },
    { name: "Tony Snell", pick: 20, pos: ["G", "F"], scoring: 56, playmaking: 30, rebounding: 36, defense: 63, ovr: 66 },
    { name: "Gorgui Dieng", pick: 21, pos: ["F", "C"], scoring: 58, playmaking: 44, rebounding: 76, defense: 70, ovr: 72 },
    { name: "Mason Plumlee", pick: 22, pos: ["C"], scoring: 60, playmaking: 45, rebounding: 78, defense: 65, ovr: 70 },
    { name: "Solomon Hill", pick: 23, pos: ["F"], scoring: 50, playmaking: 46, rebounding: 55, defense: 68, ovr: 66 },
    { name: "Tim Hardaway Jr.", pick: 24, pos: ["G"], scoring: 72, playmaking: 45, rebounding: 42, defense: 48, ovr: 68 },
    { name: "Reggie Bullock", pick: 25, pos: ["G", "F"], scoring: 60, playmaking: 30, rebounding: 44, defense: 60, ovr: 70 },
    { name: "Andre Roberson", pick: 26, pos: ["G", "F"], scoring: 25, playmaking: 24, rebounding: 60, defense: 90, ovr: 73 },
    { name: "Rudy Gobert", pick: 27, pos: ["C"], scoring: 62, playmaking: 35, rebounding: 92, defense: 96, ovr: 88 },
    { name: "Livio Jean-Charles", pick: 28, pos: ["F"], scoring: 30, playmaking: 15, rebounding: 45, defense: 35, ovr: 42 },
    { name: "Archie Goodwin", pick: 29, pos: ["G"], scoring: 58, playmaking: 40, rebounding: 30, defense: 36, ovr: 55 },
    { name: "Nemanja Nedovic", pick: 30, pos: ["G"], scoring: 36, playmaking: 42, rebounding: 20, defense: 32, ovr: 45 },
  ]},
  { year: 2014, players: [
    ...
    { name: "Adreian Payne", pick: 15, pos: ["F", "C"], scoring: 50, playmaking: 25, rebounding: 65, defense: 55, ovr: 61 },
    { name: "Jusuf Nurkic", pick: 16, pos: ["C"], scoring: 72, playmaking: 55, rebounding: 78, defense: 66, ovr: 72 },
    { name: "James Young", pick: 17, pos: ["F"], scoring: 55, playmaking: 35, rebounding: 45, defense: 40, ovr: 58 },
    { name: "Tyler Ennis", pick: 18, pos: ["G"], scoring: 45, playmaking: 68, rebounding: 30, defense: 48, ovr: 63 },
    { name: "Gary Harris", pick: 19, pos: ["G"], scoring: 68, playmaking: 48, rebounding: 42, defense: 70, ovr: 66 },
    { name: "Bruno Caboclo", pick: 20, pos: ["F"], scoring: 55, playmaking: 30, rebounding: 55, defense: 58, ovr: 63 },
    { name: "Mitch McGary", pick: 21, pos: ["F", "C"], scoring: 45, playmaking: 30, rebounding: 60, defense: 45, ovr: 55 },
    { name: "Jordan Adams", pick: 22, pos: ["G"], scoring: 48, playmaking: 40, rebounding: 35, defense: 45, ovr: 54 },
    { name: "Rodney Hood", pick: 23, pos: ["G", "F"], scoring: 70, playmaking: 45, rebounding: 42, defense: 50, ovr: 66 },
    { name: "Shabazz Napier", pick: 24, pos: ["G"], scoring: 58, playmaking: 62, rebounding: 32, defense: 48, ovr: 68 },
    { name: "Clint Capela", pick: 25, pos: ["C"], scoring: 66, playmaking: 35, rebounding: 82, defense: 78, ovr: 74 },
    { name: "P.J. Hairston", pick: 26, pos: ["G", "F"], scoring: 52, playmaking: 30, rebounding: 40, defense: 38, ovr: 55 },
    { name: "Bogdan Bogdanovic", pick: 27, pos: ["G"], scoring: 76, playmaking: 55, rebounding: 45, defense: 52, ovr: 74 },
    { name: "C.J. Wilcox", pick: 28, pos: ["G"], scoring: 55, playmaking: 30, rebounding: 30, defense: 35, ovr: 56 },
    { name: "Josh Huestis", pick: 29, pos: ["F"], scoring: 35, playmaking: 30, rebounding: 55, defense: 60, ovr: 54 },
    { name: "Kyle Anderson", pick: 30, pos: ["F"], scoring: 55, playmaking: 78, rebounding: 65, defense: 72, ovr: 78 },
    { name: "Nikola Jokic", pick: 41, pos: ["C"], scoring: 94, playmaking: 94, rebounding: 94, defense: 70, ovr: 98 },
  ]},
  { year: 2015, players: [
    ...
    { name: "Mario Hezonja", pick: 5, pos: ["F"], scoring: 74, playmaking: 52, rebounding: 48, defense: 50, ovr: 75 },
    ...
    { name: "Stanley Johnson", pick: 8, pos: ["F"], scoring: 50, playmaking: 42, rebounding: 55, defense: 76, ovr: 71 },
    ...
    { name: "Trey Lyles", pick: 12, pos: ["F"], scoring: 68, playmaking: 42, rebounding: 68, defense: 52, ovr: 75 },
    { name: "Devin Booker", pick: 13, pos: ["G"], scoring: 96, playmaking: 72, rebounding: 41, defense: 59, ovr: 95 },
    { name: "Cameron Payne", pick: 14, pos: ["G"], scoring: 68, playmaking: 76, rebounding: 30, defense: 48, ovr: 77 },
    ...
    { name: "Rashad Vaughn", pick: 17, pos: ["G"], scoring: 48, playmaking: 30, rebounding: 28, defense: 38, ovr: 50 },
    { name: "Sam Dekker", pick: 18, pos: ["F"], scoring: 58, playmaking: 38, rebounding: 55, defense: 55, ovr: 68 },
    { name: "Jerian Grant", pick: 19, pos: ["G"], scoring: 55, playmaking: 68, rebounding: 30, defense: 50, ovr: 70 },
    { name: "Delon Wright", pick: 20, pos: ["G"], scoring: 64, playmaking: 60, rebounding: 45, defense: 68, ovr: 66 },
    { name: "Justin Anderson", pick: 21, pos: ["G", "F"], scoring: 52, playmaking: 35, rebounding: 45, defense: 55, ovr: 62 },
    { name: "Bobby Portis", pick: 22, pos: ["F", "C"], scoring: 72, playmaking: 42, rebounding: 68, defense: 52, ovr: 70 },
    { name: "Rondae Hollis-Jefferson", pick: 23, pos: ["F"], scoring: 55, playmaking: 45, rebounding: 62, defense: 74, ovr: 74 },
    { name: "Tyus Jones", pick: 24, pos: ["G"], scoring: 62, playmaking: 84, rebounding: 28, defense: 62, ovr: 79 },
    { name: "Jarell Martin", pick: 25, pos: ["F"], scoring: 50, playmaking: 30, rebounding: 48, defense: 40, ovr: 52 },
    { name: "Nikola Milutinov", pick: 26, pos: ["C"], scoring: 42, playmaking: 25, rebounding: 62, defense: 58, ovr: 58 },
    { name: "Larry Nance Jr.", pick: 27, pos: ["F","C"], scoring: 65, playmaking: 45, rebounding: 72, defense: 72, ovr: 72 },
    { name: "R.J. Hunter", pick: 28, pos: ["G"], scoring: 48, playmaking: 32, rebounding: 22, defense: 32, ovr: 48 },
    { name: "Chris McCullough", pick: 29, pos: ["F"], scoring: 42, playmaking: 25, rebounding: 45, defense: 38, ovr: 46 },
    { name: "Kevon Looney", pick: 30, pos: ["C"], scoring: 35, playmaking: 40, rebounding: 78, defense: 72, ovr: 76 },
  ...
  { year: 2016, players: [
    ...
    { name: "Domantas Sabonis", pick: 11, pos: ["F", "C"], scoring: 90, playmaking: 72, rebounding: 95, defense: 68, ovr: 90 },
    { name: "Taurean Prince", pick: 12, pos: ["F"], scoring: 66, playmaking: 45, rebounding: 52, defense: 58, ovr: 64 },
    { name: "Georgios Papagiannis", pick: 13, pos: ["C"], scoring: 35, playmaking: 20, rebounding: 45, defense: 30, ovr: 44 },
    ...
    { name: "Guerschon Yabusele", pick: 16, pos: ["F", "C"], scoring: 72, playmaking: 58, rebounding: 70, defense: 62, ovr: 73 },
    { name: "Wade Baldwin", pick: 17, pos: ["G"], scoring: 55, playmaking: 55, rebounding: 40, defense: 58, ovr: 56 },
    { name: "Henry Ellenson", pick: 18, pos: ["F"], scoring: 50, playmaking: 40, rebounding: 48, defense: 35, ovr: 49 },
    { name: "Malik Beasley", pick: 19, pos: ["G"], scoring: 82, playmaking: 45, rebounding: 40, defense: 52, ovr: 76 },
    { name: "Caris LeVert", pick: 20, pos: ["G", "F"], scoring: 78, playmaking: 75, rebounding: 45, defense: 55, ovr: 78 },
    { name: "DeAndre Bembry", pick: 21, pos: ["G", "F"], scoring: 48, playmaking: 50, rebounding: 55, defense: 68, ovr: 60 },
    { name: "Malachi Richardson", pick: 22, pos: ["G"], scoring: 42, playmaking: 35, rebounding: 30, defense: 40, ovr: 44 },
    { name: "Ante Zizic", pick: 23, pos: ["C"], scoring: 55, playmaking: 30, rebounding: 62, defense: 48, ovr: 58 },
    { name: "Timothe Luwawu-Cabarrot", pick: 24, pos: ["G", "F"], scoring: 58, playmaking: 40, rebounding: 45, defense: 60, ovr: 62 },
    { name: "Brice Johnson", pick: 25, pos: ["F"], scoring: 40, playmaking: 25, rebounding: 50, defense: 35, ovr: 44 },
    { name: "Furkan Korkmaz", pick: 26, pos: ["G"], scoring: 62, playmaking: 45, rebounding: 30, defense: 42, ovr: 62 },
    { name: "Pascal Siakam", pick: 27, pos: ["F"], scoring: 89, playmaking: 65, rebounding: 75, defense: 79, ovr: 89 },
    { name: "Skal Labissiere", pick: 28, pos: ["F", "C"], scoring: 65, playmaking: 35, rebounding: 58, defense: 45, ovr: 65 },
    { name: "Dejounte Murray", pick: 29, pos: ["G"], scoring: 78, playmaking: 68, rebounding: 62, defense: 78, ovr: 78 },
    { name: "Damian Jones", pick: 30, pos: ["C"], scoring: 55, playmaking: 25, rebounding: 65, defense: 60, ovr: 63 },
  ...
  { year: 2017, players: [
    ...
    { name: "Jayson Tatum", pick: 3, pos: ["F"], scoring: 95, playmaking: 63, rebounding: 73, defense: 77, ovr: 95 },
    ...
    { name: "Jonathan Isaac", pick: 6, pos: ["F"], scoring: 58, playmaking: 40, rebounding: 65, defense: 88, ovr: 78 },
    { name: "Lauri Markkanen", pick: 7, pos: ["F"], scoring: 88, playmaking: 42, rebounding: 72, defense: 55, ovr: 87 },
    ...
    { name: "Donovan Mitchell", pick: 13, pos: ["G"], scoring: 96, playmaking: 70, rebounding: 56, defense: 66, ovr: 94 },
    { name: "Bam Adebayo", pick: 14, pos: ["C"], scoring: 81, playmaking: 63, rebounding: 85, defense: 93, ovr: 89 },
    { name: "Justin Jackson", pick: 15, pos: ["F"], scoring: 62, playmaking: 45, rebounding: 50, defense: 55, ovr: 68 },
    { name: "Justin Patton", pick: 16, pos: ["C"], scoring: 45, playmaking: 30, rebounding: 50, defense: 40, ovr: 47 },
    { name: "D.J. Wilson", pick: 17, pos: ["F", "C"], scoring: 48, playmaking: 35, rebounding: 55, defense: 50, ovr: 55 },
    { name: "T.J. Leaf", pick: 18, pos: ["F"], scoring: 45, playmaking: 30, rebounding: 42, defense: 35, ovr: 46 },
    { name: "John Collins", pick: 19, pos: ["F", "C"], scoring: 76, playmaking: 45, rebounding: 72, defense: 58, ovr: 74 },
    { name: "Harry Giles", pick: 20, pos: ["F", "C"], scoring: 48, playmaking: 42, rebounding: 55, defense: 42, ovr: 52 },
    { name: "Terrance Ferguson", pick: 21, pos: ["G"], scoring: 50, playmaking: 30, rebounding: 38, defense: 58, ovr: 58 },
    ...
    { name: "Tyler Lydon", pick: 24, pos: ["F"], scoring: 35, playmaking: 25, rebounding: 40, defense: 35, ovr: 44 },
    { name: "Anzejs Pasecniks", pick: 25, pos: ["C"], scoring: 48, playmaking: 35, rebounding: 55, defense: 40, ovr: 50 },
    { name: "Caleb Swanigan", pick: 26, pos: ["F", "C"], scoring: 38, playmaking: 30, rebounding: 48, defense: 32, ovr: 46 },
    { name: "Kyle Kuzma", pick: 27, pos: ["F"], scoring: 74, playmaking: 45, rebounding: 55, defense: 48, ovr: 70 },
    { name: "Tony Bradley", pick: 28, pos: ["C"], scoring: 45, playmaking: 25, rebounding: 68, defense: 55, ovr: 60 },
    { name: "Derrick White", pick: 29, pos: ["G"], scoring: 76, playmaking: 65, rebounding: 45, defense: 80, ovr: 78 },
    { name: "Josh Hart", pick: 30, pos: ["G", "F"], scoring: 62, playmaking: 55, rebounding: 78, defense: 72, ovr: 83 },
  ]},
  { year: 2018, players: [
    ...
    { name: "Luka Doncic", pick: 3, pos: ["G","F"], scoring: 95, playmaking: 93, rebounding: 69, defense: 55, ovr: 97 },
    { name: "Jaren Jackson Jr.", pick: 4, pos: ["F","C"], scoring: 78, playmaking: 42, rebounding: 68, defense: 92, ovr: 85 },
    { name: "Trae Young", pick: 5, pos: ["G"], scoring: 93, playmaking: 97, rebounding: 33, defense: 50, ovr: 92 },
    ...
    { name: "Shai Gilgeous-Alexander", pick: 11, pos: ["G"], scoring: 94, playmaking: 80, rebounding: 45, defense: 80, ovr: 98 },
    { name: "Miles Bridges", pick: 12, pos: ["F"], scoring: 76, playmaking: 42, rebounding: 58, defense: 58, ovr: 76 },
    { name: "Jerome Robinson", pick: 13, pos: ["G"], scoring: 66, playmaking: 58, rebounding: 30, defense: 48, ovr: 68 },
    { name: "Michael Porter Jr.", pick: 14, pos: ["F"], scoring: 82, playmaking: 40, rebounding: 62, defense: 50, ovr: 80 },
    { name: "Troy Brown Jr.", pick: 15, pos: ["G", "F"], scoring: 62, playmaking: 60, rebounding: 62, defense: 66, ovr: 73 },
    { name: "Zhaire Smith", pick: 16, pos: ["G"], scoring: 62, playmaking: 50, rebounding: 40, defense: 62, ovr: 70 },
    ...
    { name: "Josh Okogie", pick: 20, pos: ["G"], scoring: 55, playmaking: 45, rebounding: 58, defense: 78, ovr: 75 },
    { name: "Grayson Allen", pick: 21, pos: ["G"], scoring: 78, playmaking: 52, rebounding: 42, defense: 68, ovr: 81 },
    { name: "Chandler Hutchison", pick: 22, pos: ["F"], scoring: 68, playmaking: 42, rebounding: 62, defense: 58, ovr: 75 },
    { name: "Aaron Holiday", pick: 23, pos: ["G"], scoring: 58, playmaking: 68, rebounding: 32, defense: 55, ovr: 73 },
    { name: "Anfernee Simons", pick: 24, pos: ["G"], scoring: 86, playmaking: 62, rebounding: 34, defense: 52, ovr: 84 },
    { name: "Moritz Wagner", pick: 25, pos: ["F", "C"], scoring: 68, playmaking: 40, rebounding: 66, defense: 48, ovr: 77 },
    { name: "Landry Shamet", pick: 26, pos: ["G"], scoring: 68, playmaking: 48, rebounding: 28, defense: 48, ovr: 77 },
    { name: "Robert Williams III", pick: 27, pos: ["C"], scoring: 62, playmaking: 38, rebounding: 72, defense: 82, ovr: 70 },
    { name: "Jacob Evans", pick: 28, pos: ["F"], scoring: 45, playmaking: 38, rebounding: 42, defense: 52, ovr: 62 },
    { name: "Dzanan Musa", pick: 29, pos: ["F"], scoring: 62, playmaking: 48, rebounding: 42, defense: 40, ovr: 65 },
    { name: "Omari Spellman", pick: 30, pos: ["F"], scoring: 52, playmaking: 35, rebounding: 55, defense: 42, ovr: 63 },
  ]},
  { year: 2019, players: [
    ...
    { name: "Romeo Langford", pick: 14, pos: ["G", "F"], scoring: 45, playmaking: 35, rebounding: 40, defense: 58, ovr: 52, floor: 0.42 },
    { name: "Sekou Doumbouya", pick: 15, pos: ["F"], scoring: 42, playmaking: 30, rebounding: 45, defense: 48, ovr: 56, floor: 0.4 },
    { name: "Chuma Okeke", pick: 16, pos: ["F"], scoring: 55, playmaking: 35, rebounding: 55, defense: 60, ovr: 62, floor: 0.6 },
    { name: "Nickeil Alexander-Walker", pick: 17, pos: ["G"], scoring: 66, playmaking: 55, rebounding: 38, defense: 62, ovr: 72, floor: 0.7 },
    { name: "Goga Bitadze", pick: 18, pos: ["C"], scoring: 50, playmaking: 25, rebounding: 68, defense: 65, ovr: 68, floor: 0.7 },
    { name: "Luka Samanic", pick: 19, pos: ["F"], scoring: 42, playmaking: 30, rebounding: 48, defense: 40, ovr: 50, floor: 0.42 },
    ...
    { name: "Grant Williams", pick: 22, pos: ["F"], scoring: 58, playmaking: 38, rebounding: 50, defense: 68, ovr: 74, floor: 0.58 },
    { name: "Darius Bazley", pick: 23, pos: ["F"], scoring: 55, playmaking: 35, rebounding: 50, defense: 52, ovr: 58, floor: 0.4 },
    { name: "Ty Jerome", pick: 24, pos: ["G"], scoring: 68, playmaking: 62, rebounding: 30, defense: 42, ovr: 79, floor: 0.62 },
    { name: "Nassir Little", pick: 25, pos: ["F"], scoring: 52, playmaking: 35, rebounding: 42, defense: 55, ovr: 58, floor: 0.48 },
    { name: "Dylan Windler", pick: 26, pos: ["G", "F"], scoring: 40, playmaking: 30, rebounding: 40, defense: 38, ovr: 45, floor: 0.4 },
    { name: "Mfiondu Kabengele", pick: 27, pos: ["F", "C"], scoring: 48, playmaking: 25, rebounding: 50, defense: 40, ovr: 48, floor: 0.4 },
    { name: "Jordan Poole", pick: 28, pos: ["G"], scoring: 88, playmaking: 65, rebounding: 32, defense: 35, ovr: 84, floor: 0.55 },
    { name: "Keldon Johnson", pick: 29, pos: ["G", "F"], scoring: 72, playmaking: 48, rebounding: 55, defense: 55, ovr: 72, floor: 0.75 },
    { name: "Kevin Porter Jr.", pick: 30, pos: ["G"], scoring: 82, playmaking: 78, rebounding: 40, defense: 42, ovr: 81, floor: 0.38 },
  ...
  { year: 2020, players: [
    ...
    { name: "Isaac Okoro", pick: 5, pos: ["G", "F"], scoring: 58, playmaking: 40, rebounding: 45, defense: 78, ovr: 70, floor: 0.7 },
    ...
    { name: "Jalen Smith", pick: 10, pos: ["F", "C"], scoring: 62, playmaking: 30, rebounding: 72, defense: 55, ovr: 78, floor: 0.65 },
    ...
    { name: "Kira Lewis Jr.", pick: 13, pos: ["G"], scoring: 55, playmaking: 58, rebounding: 20, defense: 30, ovr: 54, floor: 0.38 },
    ...
    { name: "Aleksej Pokusevski", pick: 17, pos: ["F"], scoring: 55, playmaking: 68, rebounding: 58, defense: 50, ovr: 72, floor: 0.38 },
    { name: "Josh Green", pick: 18, pos: ["G", "F"], scoring: 52, playmaking: 40, rebounding: 42, defense: 68, ovr: 70, floor: 0.65 },
    ...
    { name: "Zeke Nnaji", pick: 22, pos: ["F", "C"], scoring: 40, playmaking: 25, rebounding: 55, defense: 48, ovr: 58, floor: 0.58 },
    { name: "Leandro Bolmaro", pick: 23, pos: ["G", "F"], scoring: 35, playmaking: 45, rebounding: 30, defense: 40, ovr: 45, floor: 0.45 },
    { name: "R.J. Hampton", pick: 24, pos: ["G"], scoring: 55, playmaking: 45, rebounding: 30, defense: 35, ovr: 55, floor: 0.4 },
    { name: "Immanuel Quickley", pick: 25, pos: ["G"], scoring: 78, playmaking: 75, rebounding: 42, defense: 55, ovr: 84, floor: 0.58 },
    { name: "Payton Pritchard", pick: 26, pos: ["G"], scoring: 76, playmaking: 62, rebounding: 38, defense: 42, ovr: 80, floor: 0.76 },
    { name: "Udoka Azubuike", pick: 27, pos: ["C"], scoring: 30, playmaking: 15, rebounding: 55, defense: 45, ovr: 44, floor: 0.42 },
    { name: "Jaden McDaniels", pick: 28, pos: ["F"], scoring: 68, playmaking: 42, rebounding: 58, defense: 90, ovr: 88, floor: 0.78 },
    { name: "Malachi Flynn", pick: 29, pos: ["G"], scoring: 62, playmaking: 55, rebounding: 25, defense: 35, ovr: 62, floor: 0.38 },
  ...
  { year: 2021, players: [
    ...
    { name: "James Bouknight", pick: 11, pos: ["G"], scoring: 55, playmaking: 30, rebounding: 25, defense: 30, ovr: 44, floor: 0.42 },
    { name: "Joshua Primo", pick: 12, pos: ["G"], scoring: 52, playmaking: 40, rebounding: 25, defense: 28, ovr: 55, floor: 0.3 },
    { name: "Chris Duarte", pick: 13, pos: ["G"], scoring: 62, playmaking: 48, rebounding: 42, defense: 50, ovr: 60, floor: 0.65 },
    { name: "Moses Moody", pick: 14, pos: ["G", "F"], scoring: 62, playmaking: 40, rebounding: 42, defense: 62, ovr: 68, floor: 0.78 },
    ...
    { name: "Tre Mann", pick: 18, pos: ["G"], scoring: 60, playmaking: 55, rebounding: 30, defense: 38, ovr: 62, floor: 0.58 },
    { name: "Kai Jones", pick: 19, pos: ["F", "C"], scoring: 45, playmaking: 25, rebounding: 50, defense: 35, ovr: 40, floor: 0.35 },
    { name: "Jalen Johnson", pick: 20, pos: ["F"], scoring: 66, playmaking: 52, rebounding: 62, defense: 58, ovr: 66, floor: 0.72 },
    { name: "Keon Johnson", pick: 21, pos: ["G"], scoring: 45, playmaking: 35, rebounding: 30, defense: 42, ovr: 52, floor: 0.48 },
    { name: "Isaiah Jackson", pick: 22, pos: ["C"], scoring: 45, playmaking: 25, rebounding: 68, defense: 75, ovr: 70, floor: 0.45 },
    { name: "Usman Garuba", pick: 23, pos: ["F","C"], scoring: 40, playmaking: 40, rebounding: 58, defense: 68, ovr: 58, floor: 0.6 },
    { name: "Josh Christopher", pick: 24, pos: ["G"], scoring: 48, playmaking: 30, rebounding: 25, defense: 28, ovr: 40, floor: 0.35 },
    { name: "Quentin Grimes", pick: 25, pos: ["G"], scoring: 68, playmaking: 45, rebounding: 42, defense: 58, ovr: 78, floor: 0.65 },
    { name: "Bones Hyland", pick: 26, pos: ["G"], scoring: 66, playmaking: 48, rebounding: 25, defense: 30, ovr: 68, floor: 0.58 },
    { name: "Cameron Thomas", pick: 27, pos: ["G"], scoring: 82, playmaking: 48, rebounding: 30, defense: 25, ovr: 83, floor: 0.6 },
    { name: "Jaden Springer", pick: 28, pos: ["G"], scoring: 38, playmaking: 35, rebounding: 32, defense: 55, ovr: 52, floor: 0.55 },
    { name: "Day'Ron Sharpe", pick: 29, pos: ["C"], scoring: 40, playmaking: 30, rebounding: 78, defense: 55, ovr: 64, floor: 0.75 },
    { name: "Santi Aldama", pick: 30, pos: ["F", "C"], scoring: 60, playmaking: 42, rebounding: 62, defense: 52, ovr: 75, floor: 0.72 },
  ...
  { year: 2022, players: [
    ...
    { name: "Shaedon Sharpe", pick: 7, pos: ["G"], scoring: 78, playmaking: 45, rebounding: 35, defense: 48, ovr: 80, floor: 0.78, grade: "B+" },
    ...
    { name: "Ousmane Dieng", pick: 11, pos: ["F"], scoring: 40, playmaking: 35, rebounding: 38, defense: 42, ovr: 55, floor: 0.42, grade: "D" },
    ...
    { name: "AJ Griffin", pick: 16, pos: ["G", "F"], scoring: 48, playmaking: 25, rebounding: 25, defense: 30, ovr: 50, floor: 0.42, grade: "D" },
    { name: "Tari Eason", pick: 17, pos: ["F"], scoring: 62, playmaking: 40, rebounding: 62, defense: 78, ovr: 75, floor: 0.68, grade: "B-" },
    { name: "Dalen Terry", pick: 18, pos: ["G", "F"], scoring: 32, playmaking: 55, rebounding: 40, defense: 60, ovr: 58, floor: 0.48, grade: "C-" },
    { name: "Jake LaRavia", pick: 19, pos: ["F"], scoring: 62, playmaking: 45, rebounding: 55, defense: 58, ovr: 74, floor: 0.73, grade: "B" },
    ...
    { name: "David Roddy", pick: 23, pos: ["F"], scoring: 48, playmaking: 30, rebounding: 45, defense: 35, ovr: 52, floor: 0.42, grade: "D" },
    { name: "MarJon Beauchamp", pick: 24, pos: ["F"], scoring: 45, playmaking: 25, rebounding: 38, defense: 40, ovr: 52, floor: 0.42, grade: "D" },
    { name: "Blake Wesley", pick: 25, pos: ["G"], scoring: 40, playmaking: 42, rebounding: 25, defense: 55, ovr: 58, floor: 0.48, grade: "C-" },
    { name: "Wendell Moore Jr.", pick: 26, pos: ["G", "F"], scoring: 35, playmaking: 40, rebounding: 35, defense: 45, ovr: 50, floor: 0.42, grade: "D" },
    { name: "Nikola Jovic", pick: 27, pos: ["F"], scoring: 57, playmaking: 64, rebounding: 50, defense: 40, ovr: 74, floor: 0.68, grade: "B-" },
    { name: "Patrick Baldwin Jr.", pick: 28, pos: ["F"], scoring: 40, playmaking: 20, rebounding: 35, defense: 25, ovr: 45, floor: 0.42, grade: "D" },
    { name: "TyTy Washington Jr.", pick: 29, pos: ["G"], scoring: 50, playmaking: 58, rebounding: 25, defense: 35, ovr: 58, floor: 0.48, grade: "C-" },
    { name: "Peyton Watson", pick: 30, pos: ["F"], scoring: 70, playmaking: 45, rebounding: 55, defense: 78, ovr: 82, floor: 0.83, grade: "A-" },
  ]},
  { year: 2023, players: [
    ...
    { name: "Jett Howard", pick: 11, pos: ["G", "F"], scoring: 74, playmaking: 40, rebounding: 38, defense: 35, ovr: 68, floor: 0.42, grade: "D" },
    ...
    { name: "Keyonte George", pick: 16, pos: ["G"], scoring: 82, playmaking: 80, rebounding: 30, defense: 45, ovr: 80, floor: 0.73, grade: "B" },
    { name: "Jalen Hood-Schifino", pick: 17, pos: ["G"], scoring: 55, playmaking: 58, rebounding: 30, defense: 40, ovr: 58, floor: 0.42, grade: "D" },
    { name: "Jaime Jaquez Jr.", pick: 18, pos: ["F"], scoring: 78, playmaking: 68, rebounding: 55, defense: 58, ovr: 79, floor: 0.78, grade: "B+" },
    { name: "Brandin Podziemski", pick: 19, pos: ["G"], scoring: 70, playmaking: 72, rebounding: 62, defense: 52, ovr: 78, floor: 0.78, grade: "B+" },
    { name: "Cam Whitmore", pick: 20, pos: ["F"], scoring: 68, playmaking: 35, rebounding: 48, defense: 55, ovr: 70, floor: 0.62, grade: "C+" },
    { name: "Noah Clowney", pick: 21, pos: ["F", "C"], scoring: 55, playmaking: 35, rebounding: 68, defense: 60, ovr: 67, floor: 0.55, grade: "C" },
    { name: "Dariq Whitehead", pick: 22, pos: ["F"], scoring: 50, playmaking: 35, rebounding: 35, defense: 45, ovr: 55, floor: 0.42, grade: "D" },
    { name: "Kris Murray", pick: 23, pos: ["F"], scoring: 58, playmaking: 35, rebounding: 50, defense: 48, ovr: 60, floor: 0.48, grade: "C-" },
    { name: "Olivier-Maxence Prosper", pick: 24, pos: ["F"], scoring: 45, playmaking: 30, rebounding: 55, defense: 62, ovr: 58, floor: 0.48, grade: "C-" },
    { name: "Marcus Sasser", pick: 25, pos: ["G"], scoring: 68, playmaking: 55, rebounding: 30, defense: 50, ovr: 70, floor: 0.62, grade: "C+" },
    { name: "Ben Sheppard", pick: 26, pos: ["G", "F"], scoring: 58, playmaking: 45, rebounding: 48, defense: 65, ovr: 68, floor: 0.62, grade: "C+" },
    { name: "Nick Smith Jr.", pick: 27, pos: ["G"], scoring: 56, playmaking: 45, rebounding: 36, defense: 45, ovr: 54, floor: 0.55, grade: "C" },
    { name: "Brice Sensabaugh", pick: 28, pos: ["F"], scoring: 65, playmaking: 40, rebounding: 45, defense: 35, ovr: 62, floor: 0.55, grade: "C" },
    { name: "Julian Strawther", pick: 29, pos: ["G", "F"], scoring: 66, playmaking: 45, rebounding: 42, defense: 48, ovr: 68, floor: 0.62, grade: "C+" },
    { name: "Kobe Brown", pick: 30, pos: ["F"], scoring: 52, playmaking: 42, rebounding: 55, defense: 50, ovr: 58, floor: 0.48, grade: "C-" },
  ...
  { year: 2024, players: [
    ...
    { name: "Nikola Topic", pick: 12, pos: ["G"], scoring: 55, playmaking: 78, rebounding: 55, defense: 50, ovr: 72, floor: 0.73, grade: "B" },
    { name: "Devin Carter", pick: 13, pos: ["G"], scoring: 58, playmaking: 52, rebounding: 48, defense: 68, ovr: 58, floor: 0.62, grade: "C+" },
    { name: "Bub Carrington", pick: 14, pos: ["G"], scoring: 60, playmaking: 82, rebounding: 45, defense: 50, ovr: 78, floor: 0.83, grade: "A-" },
    { name: "Kel'el Ware", pick: 15, pos: ["C"], scoring: 60, playmaking: 30, rebounding: 82, defense: 68, ovr: 80, floor: 0.83, grade: "A-" },
    ...
    { name: "Tristan da Silva", pick: 18, pos: ["F"], scoring: 62, playmaking: 48, rebounding: 55, defense: 52, ovr: 68, floor: 0.73, grade: "B" },
    { name: "Ja'Kobe Walter", pick: 19, pos: ["G"], scoring: 62, playmaking: 35, rebounding: 35, defense: 48, ovr: 65, floor: 0.68, grade: "B-" },
    { name: "Jaylon Tyson", pick: 20, pos: ["G", "F"], scoring: 58, playmaking: 42, rebounding: 42, defense: 44, ovr: 64, floor: 0.68, grade: "B-" },
    { name: "Yves Missi", pick: 21, pos: ["C"], scoring: 55, playmaking: 35, rebounding: 68, defense: 66, ovr: 58, floor: 0.62, grade: "C+" },
    { name: "DaRon Holmes II", pick: 22, pos: ["F", "C"], scoring: 60, playmaking: 32, rebounding: 68, defense: 60, ovr: 72, floor: 0.68, grade: "B-" },
    { name: "AJ Johnson", pick: 23, pos: ["G"], scoring: 56, playmaking: 56, rebounding: 32, defense: 42, ovr: 60, floor: 0.62, grade: "C+" },
    { name: "Kyshawn George", pick: 24, pos: ["G", "F"], scoring: 55, playmaking: 48, rebounding: 50, defense: 58, ovr: 68, floor: 0.73, grade: "B" },
    { name: "Pacome Dadiet", pick: 25, pos: ["F"], scoring: 45, playmaking: 35, rebounding: 38, defense: 40, ovr: 52, floor: 0.55, grade: "C" },
    { name: "Dillon Jones", pick: 26, pos: ["F"], scoring: 42, playmaking: 44, rebounding: 48, defense: 45, ovr: 57, floor: 0.55, grade: "C" },
    { name: "Terrence Shannon Jr.", pick: 27, pos: ["G", "F"], scoring: 62, playmaking: 42, rebounding: 46, defense: 48, ovr: 64, floor: 0.68, grade: "B-" },
    { name: "Ryan Dunn", pick: 28, pos: ["F"], scoring: 45, playmaking: 35, rebounding: 52, defense: 72, ovr: 65, floor: 0.73, grade: "B" },
    { name: "Isaiah Collier", pick: 29, pos: ["G"], scoring: 48, playmaking: 72, rebounding: 36, defense: 46, ovr: 69, floor: 0.73, grade: "B" },
    { name: "Baylor Scheierman", pick: 30, pos: ["G", "F"], scoring: 56, playmaking: 40, rebounding: 44, defense: 42, ovr: 65, floor: 0.68, grade: "B-" },
  ]},
  { year: 2025, players: [
    ...
    { name: "Yang Hansen", pick: 16, pos: ["C"], scoring: 60, playmaking: 75, rebounding: 65, defense: 55, ovr: 80, floor: 0.73, grade: "B" },
    { name: "Joan Beringer", pick: 17, pos: ["C"], scoring: 45, playmaking: 32, rebounding: 70, defense: 78, ovr: 79, floor: 0.68, grade: "B-" },
    { name: "Walter Clayton Jr.", pick: 18, pos: ["G"], scoring: 84, playmaking: 62, rebounding: 30, defense: 45, ovr: 78, floor: 0.73, grade: "B" },
    { name: "Nolan Traore", pick: 19, pos: ["G"], scoring: 56, playmaking: 55, rebounding: 38, defense: 48, ovr: 54, floor: 0.55, grade: "C" },
    { name: "Kasparas Jakucionis", pick: 20, pos: ["G"], scoring: 68, playmaking: 84, rebounding: 45, defense: 40, ovr: 83, floor: 0.78, grade: "B+" },
    { name: "Will Riley", pick: 21, pos: ["F"], scoring: 72, playmaking: 55, rebounding: 35, defense: 30, ovr: 76, floor: 0.68, grade: "B-" },
    { name: "Drake Powell", pick: 22, pos: ["G", "F"], scoring: 45, playmaking: 30, rebounding: 40, defense: 78, ovr: 75, floor: 0.68, grade: "B-" },
    { name: "Asa Newell", pick: 23, pos: ["F"], scoring: 65, playmaking: 30, rebounding: 62, defense: 55, ovr: 79, floor: 0.73, grade: "B" },
    { name: "Nique Clifford", pick: 24, pos: ["G", "F"], scoring: 62, playmaking: 55, rebounding: 68, defense: 68, ovr: 76, floor: 0.68, grade: "B-" },
    { name: "Jase Richardson", pick: 25, pos: ["G"], scoring: 74, playmaking: 55, rebounding: 30, defense: 50, ovr: 80, floor: 0.73, grade: "B" },
    { name: "Ben Saraf", pick: 26, pos: ["G"], scoring: 55, playmaking: 78, rebounding: 32, defense: 35, ovr: 78, floor: 0.73, grade: "B" },
    { name: "Danny Wolf", pick: 27, pos: ["F", "C"], scoring: 62, playmaking: 68, rebounding: 78, defense: 50, ovr: 81, floor: 0.78, grade: "B+" },
    { name: "Hugo Gonzalez", pick: 28, pos: ["F"], scoring: 55, playmaking: 45, rebounding: 40, defense: 62, ovr: 80, floor: 0.68, grade: "B-" },
    { name: "Liam McNeeley", pick: 29, pos: ["F"], scoring: 70, playmaking: 40, rebounding: 48, defense: 38, ovr: 76, floor: 0.78, grade: "B+" },
    { name: "Yanic Konan Niederhauser", pick: 30, pos: ["F", "C"], scoring: 50, playmaking: 25, rebounding: 62, defense: 72, ovr: 76, floor: 0.68, grade: "B-" },
  ]},
  { year: 2026, players: [
    ...
    { name: "Brayden Burries", pick: 10, pos: ["G"], scoring: 70, playmaking: 50, rebounding: 38, defense: 85, ovr: 82, floor: 0.78, grade: "B+" },
    { name: "Yaxel Lendeborg", pick: 11, pos: ["F"], scoring: 70, playmaking: 60, rebounding: 72, defense: 65, ovr: 80, floor: 0.73, grade: "B" },
    { name: "Aday Mara", pick: 12, pos: ["C"], scoring: 58, playmaking: 35, rebounding: 75, defense: 70, ovr: 76, floor: 0.68, grade: "B-" },
    { name: "Nate Ament", pick: 13, pos: ["F"], scoring: 68, playmaking: 38, rebounding: 50, defense: 45, ovr: 74, floor: 0.68, grade: "B-" },
    { name: "Hannes Steinbach", pick: 14, pos: ["F"], scoring: 62, playmaking: 40, rebounding: 58, defense: 55, ovr: 70, floor: 0.62, grade: "C+" },
    { name: "Dailyn Swain", pick: 15, pos: ["G", "F"], scoring: 65, playmaking: 48, rebounding: 52, defense: 72, ovr: 74, floor: 0.62, grade: "C+" },
    { name: "Bennett Stirtz", pick: 16, pos: ["G"], scoring: 70, playmaking: 80, rebounding: 32, defense: 50, ovr: 76, floor: 0.73, grade: "B" },
    { name: "Ebuka Okorie", pick: 17, pos: ["G"], scoring: 68, playmaking: 55, rebounding: 30, defense: 52, ovr: 70, floor: 0.62, grade: "C+" },
    { name: "Christian Anderson Jr.", pick: 18, pos: ["G"], scoring: 70, playmaking: 52, rebounding: 35, defense: 55, ovr: 75, floor: 0.68, grade: "B-" },
    { name: "Allen Graves", pick: 19, pos: ["F"], scoring: 58, playmaking: 35, rebounding: 60, defense: 52, ovr: 66, floor: 0.55, grade: "C" },
    { name: "Jayden Quaintance", pick: 20, pos: ["C"], scoring: 50, playmaking: 35, rebounding: 78, defense: 92, ovr: 78, floor: 0.55, grade: "C" },
    { name: "Karim Lopez", pick: 21, pos: ["F"], scoring: 68, playmaking: 48, rebounding: 58, defense: 62, ovr: 76, floor: 0.68, grade: "B-" },
    { name: "Labaron Philon Jr.", pick: 22, pos: ["G"], scoring: 78, playmaking: 62, rebounding: 35, defense: 45, ovr: 78, floor: 0.68, grade: "B-" },
    { name: "Zuby Ejiofor", pick: 23, pos: ["F", "C"], scoring: 60, playmaking: 35, rebounding: 68, defense: 60, ovr: 70, floor: 0.62, grade: "C+" },
    { name: "Cameron Carr", pick: 24, pos: ["G"], scoring: 60, playmaking: 45, rebounding: 32, defense: 48, ovr: 64, floor: 0.55, grade: "C" },
    { name: "Sergio De Larrea", pick: 25, pos: ["G"], scoring: 62, playmaking: 60, rebounding: 42, defense: 48, ovr: 70, floor: 0.62, grade: "C+" },
    { name: "Tarris Reed Jr.", pick: 26, pos: ["C"], scoring: 50, playmaking: 30, rebounding: 68, defense: 58, ovr: 62, floor: 0.48, grade: "C-" },
    { name: "Chris Cenac Jr.", pick: 27, pos: ["F", "C"], scoring: 52, playmaking: 30, rebounding: 62, defense: 55, ovr: 60, floor: 0.48, grade: "C-" },
    { name: "Joshua Jefferson", pick: 28, pos: ["F"], scoring: 50, playmaking: 35, rebounding: 55, defense: 50, ovr: 58, floor: 0.48, grade: "C-" },
    { name: "Alex Karaban", pick: 29, pos: ["F"], scoring: 58, playmaking: 38, rebounding: 52, defense: 60, ovr: 64, floor: 0.55, grade: "C" },
    { name: "Koa Peat", pick: 30, pos: ["F"], scoring: 65, playmaking: 35, rebounding: 58, defense: 45, ovr: 65, floor: 0.55, grade: "C" },
  ]},
];
...
// Leaderboard/analytics backend (Supabase). The anon key is meant to be public -
// it only allows inserting a run and reading runs, per the table's RLS policies.
const SUPABASE_URL = "https://bslfbofdrzsdkzjrcubd.supabase.co";
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJzbGZib2ZkcnpzZGt6anJjdWJkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ0ODczMjEsImV4cCI6MjEwMDA2MzMyMX0.UM1w5ZrI8zkSRy98csQkOm-QYdGv-ApHP1mMrgRrVLk";

// Fire-and-forget: log a finished run for the daily leaderboard and analytics.
// Never blocks or surfaces errors to the player - if it fails (offline, ad
// blocker, etc.) the game just continues normally.
function submitRun(roster, coach, mode, rings) {
  try {
    fetch(`${SUPABASE_URL}/rest/v1/runs`, {
      ...
      body: JSON.stringify({
        ...
        players: roster.map((p) => ({
          name: p.name, slot: p.slot, pick: p.pick, classYear: p.classYear, ovr: p.ovr,
        })),
      }),
    }).catch(() => {});
  } catch {
    // ignore - never let a network hiccup affect gameplay
  }
}

// Today's best run per mode (highest rings, earliest submission on ties).
// Separate per mode since Easy/Hard/Impossible share identical sim odds - mixing them
// would let a lucky easy-mode run bury a genuinely hard blind draft.
async function fetchTodaysBest() {
  try {
    const startOfDayUTC = new Date();
    startOfDayUTC.setUTCHours(0, 0, 0, 0);
    const url = `${SUPABASE_URL}/rest/v1/runs?select=rings,mode,coach_name,players,created_at`
      + `&created_at=gte.${startOfDayUTC.toISOString()}`
      + `&order=rings.desc,created_at.asc`;
    ...
    for (const row of rows) {
      if (!best[row.mode]) best[row.mode] = row;
    }
    return best;
  } catch {
    return {};
...
export default function SixRings() {
  ...
  const [todaysBest, setTodaysBest] = useState({});
  ...
  function startSim() {
    ...
    setSimResult(result);
    submitRun(roster, coach, mode, result.rings);
    setVisibleYears(0);
  ...
  return (
    <div className="wrap">
      <style>{`
        ...
        .modeBtn:hover { border-color: #6FBF73; background: #232D3A; }
        .modeBtn.hard:hover { border-color: #D9B441; }
        .modeBtn.impossible:hover { border-color: #D9645A; }
        .modeName { font-family: 'Anton', sans-serif; font-size: 26px; letter-spacing: 1px; color: #6FBF73; margin-bottom: 8px; }
        .modeBtn.hard .modeName { color: #D9B441; }
        .modeBtn.impossible .modeName { color: #D9645A; }
        .modeDesc { font-size: 13px; line-height: 1.5; color: #8B96A5; }
        .easyBanner { background: rgba(111,191,115,0.12); border: 1px solid rgba(111,191,115,0.4); border-radius: 8px; padding: 10px 14px; margin-bottom: 16px; font-size: 12.5px; color: #9FDBA2; text-align: center; }
        .hardBanner { background: rgba(217,180,65,0.12); border: 1px solid rgba(217,180,65,0.4); border-radius: 8px; padding: 10px 14px; margin-bottom: 16px; font-size: 12.5px; color: #E8CC7A; text-align: center; }
        .impossibleBanner { background: rgba(217,100,90,0.12); border: 1px solid rgba(217,100,90,0.4); border-radius: 8px; padding: 10px 14px; margin-bottom: 16px; font-size: 12.5px; color: #E8968E; text-align: center; }

        .todaysBestGroup { display: flex; flex-direction: column; gap: 10px; margin-bottom: 18px; }
        .todaysBest { background: rgba(111,191,115,0.08); border: 1px solid rgba(111,191,115,0.35); border-radius: 10px; padding: 12px 18px; text-align: center; }
        .todaysBest.hard { background: rgba(217,180,65,0.08); border-color: rgba(217,180,65,0.35); }
        .todaysBest.impossible { background: rgba(217,100,90,0.08); border-color: rgba(217,100,90,0.35); }
        .todaysBest .tbLabel { font-family: 'IBM Plex Mono', monospace; font-size: 11px; letter-spacing: 1.5px; color: #6FBF73; text-transform: uppercase; margin-bottom: 6px; }
        .todaysBest.hard .tbLabel { color: #D9B441; }
        .todaysBest.impossible .tbLabel { color: #D9645A; }
        .todaysBest .tbNames { font-size: 13.5px; color: #EDE6D6; margin-bottom: 4px; font-family: 'IBM Plex Mono', monospace; }
        .todaysBest .tbPos { opacity: 0.7; margin-right: 2px; }
        .todaysBest .tbSep { color: #4A5568; margin: 0 7px; }
        .todaysBest .tbMeta { font-size: 12px; color: #8B96A5; }
      ...
      <div className="stage">
        ...
        {phase === "modeSelect" && ["easy", "hard", "impossible"].some((m) => todaysBest[m]) && (
          <div className="todaysBestGroup">
            {["easy", "hard", "impossible"].map((m) => {
              const run = todaysBest[m];
              if (!run) return null;
              return (
                <div className={"todaysBest " + m} key={m}>
                  <div className="tbLabel">{m.toUpperCase()} &mdash; Today's Best</div>
                  <div className="tbNames">
                    {byPosition(run.players).map((p, i) => (
                      <React.Fragment key={p.name}>
                        {i > 0 && <span className="tbSep">&middot;</span>}
                        <span className="tbPos">{p.slot}</span>{" "}{p.name} {p.ovr}
                      </React.Fragment>
                    ))}
                  </div>
                  <div className="tbMeta">
                    {run.rings} ring{run.rings === 1 ? "" : "s"} under {run.coach_name}
                  </div>
                </div>
              );
            })}
        ...
        <div className="card">
          {phase === "draft" && (
            <>
              ...
              {mode === "easy" && (
                <div className="easyBanner">EASY MODE &mdash; ratings, skill bars, and potential grades are visible while you draft.</div>
              )}
              {mode === "hard" && (
